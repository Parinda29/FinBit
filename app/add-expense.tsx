    ...
    >
      ...
      <View style={styles.heroCard}>
        ...
        <View style={styles.heroTopRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.heroSubtitle}>Track where your money goes</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            placeholder="Add optional details (vendor, reference, etc.)"
      ...
      {/* Save Button */}
      <TouchableOpacity style={styles.saveButton} onPress={onSaveExpense} disabled={loading}>
        {loading ? (
